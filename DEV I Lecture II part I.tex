...
what does each instruction do? \textbf{Try to guess and discuss!}
\end{frame}
...
\left\{
\begin{matrix}
(PC,S) \overset{fwd 3}{\rightarrow} (PC+1,S[Position \mapsto S.Position+(0,3)]) &when& S.Orientation=Forward& \\
(PC,S) \overset{fwd 3}{\rightarrow} (PC+1,S[Position \mapsto S.Position-(0,3)]) &when& S.Orientation=Backward& \\
(PC,S) \overset{fwd 3}{\rightarrow} (PC+1,S[Position \mapsto S.Position+(3,0)]) &when& S.Orientation=Right& \\
(PC,S) \overset{fwd 3}{\rightarrow} (PC+1,S[Position \mapsto S.Position-(3,0)]) &when& S.Orientation=Left& \\
\end{matrix}
\right.
$$
...
PC & S.Pose & S.Orientation & S.Position \\
\hline
25\footnote{Assuming good weather} & Standing & Right & (10,20) \\
\hline
\end{tabular}
}
\end{frame}
...
PC & S.Pose & S.Orientation & S.Position \\
\hline
27\footnote{Assuming bad weather} & Standing & Right & (10,20) \\
\hline
\end{tabular}
}
\end{frame}
