...
PC & S.Pose & S.Orientation & S.Position \\
\hline
\red{2} & Standing & Forward & (0,\red{3}) \\
\hline
\end{tabular}
} \ \\ \ \\ \ \\
...
PC & S.Pose & S.Orientation & S.Position \\
\hline
\red{105} & Standing & Left & (\red{7},20) \\
\hline
\end{tabular}
}
\end{frame}
...
PC & S.Pose & S.Orientation & S.Position \\
\hline
\red{105} & Standing & Right & (\red{13},20) \\
\hline
\end{tabular}
}
\end{frame}
...
PC & S.Pose & S.Orientation & S.Position \\
\hline
\red{25\footnote{Assuming student's shirt is black}} & Standing & Right & (10,20) \\
\hline
\end{tabular}
}
\end{frame}
...
PC & S.Pose & S.Orientation & S.Position \\
\hline
\red{27\footnote{Assuming student's shirt is not black}} & Standing & Right & (10,20) \\
\hline
\end{tabular}
}
\end{frame}
...
PC & S.Pose & S.Orientation & S.Position \\
\hline
\red{25\footnote{As long as it is sunny}} & Standing & Right & (10,20) \\
\hline
\end{tabular}
}
\end{frame}
...
PC & S.Pose & S.Orientation & S.Position \\
\hline
\red{27\footnote{When it stops being sunny}} & Standing & Right & (10,20) \\
\hline
\end{tabular}
}
\end{frame}
