...
\opgave{Reverse}{1}
\subopgave{Write a program that asks for a user’s input and prints that string in reverse. You must do this by hand, that is with an explicit loop instead of other operators.}{}{1}
