...
\begin{slide}{
\item Numbers without dot/comma
\item \texttt{0}, \texttt{100}, \texttt{-500}, ...
}\end{slide}

\begin{slide}{
\item Typical arithmetic operations on numbers (\textbf{not in Python 3})
\item \texttt{3 + 5 = 8}, \texttt{5 / 2 = 2}, \texttt{40 * 5 = 200}, ...
}\end{slide}

\SlideSubSection{Floating points}
\begin{slide}{
\item Numbers with dot/comma
\item \texttt{0.0}, \texttt{2.5}, \texttt{10.0e3}, \texttt{3.1e-5}, \texttt{-.1e-5}, ...
}\end{slide}

\begin{slide}{
\item Typical arithmetic operations on numbers
\item \texttt{5.0 / 2.0 = ?}, \texttt{10.0e3 / 0.1 = ?}, \texttt{3.1e-5 + 1.0e5 = ?}, ...
\item \textbf{Can you guess the results?}
\pause
\item \texttt{5.0 / 2.0 = 2.5}, \texttt{10.0e3 / 0.1 = 10.0e4}, \texttt{3.1e-5 + 1.0e5 = 100000.000031}, ...
}\end{slide}
...
\begin{slide}{
\item \texttt{int(2.5) = ?}, \texttt{float(3) = ?}
\item \textbf{Can you guess the results?}
\pause
\item \texttt{int(2.5) = 2}, \texttt{float(3) = 3.0}
}\end{slide}
...
\begin{slide}{
\item \texttt{floor(2.5) = ?}, \texttt{ceil(2.5) = ?}
\item \textbf{Can you guess the results?}
\pause
\item \texttt{floor(2.5) = 2.0}, \texttt{ceil(2.5) = 3.0}
}\end{slide}
...
\SlideSubSection{Python 3 integer division}
\begin{slide}{
\item Traditional integer division is now \texttt{//}
\item \texttt{5 // 2 = 2}
}\end{slide}
...
\begin{slide}{
\item \texttt{5.0 > 2.0 = ?}, \texttt{(3 > 4) | (5 == (3 + 2)) = ?}, \texttt{True \& False = ?}, ...
\item \textbf{Can you guess the results?}
\pause
\item \texttt{5.0 > 2.0 = true}, \texttt{(3 > 4) | (5 == (3 + 2)) = False}, \texttt{True \& False = False}, ...
}\end{slide}
